...
//
//
// //squares need to be twice as large when on mobile
// var squareSizeMobile = function squaresSizeMobile(){
// if ($('#squares').width() > $('#squares').height()){
//   return $('#squares').width() / 20
// } else {
//   return $('#squares').height() / 20
// }
// }
//
//
// var square = squareSizeMobile(),
// //this accomodates mobile resizing of entire container
//   w = $('#squares').width();
//   h = $('#squares').height();
//
// // create the svg
...
//     .enter().append('rect')
//     .attr({
//       width: square - squareSizeMobile() / 18,
//       height: square - squareSizeMobile() / 18,
//       x: function(d, i) {
//         return i * square;
//       },
//       y: n * square,
